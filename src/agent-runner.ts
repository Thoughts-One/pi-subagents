...
export async function runAgent(
  ...
  // A model pin is authority, and must resolve before environment discovery,
  // extension loading, or child-session construction. An authority from a nested
  // registry takes precedence over this process-global registry.
  const configuredModel = options.modelAuthority
    ? options.modelAuthority.configuredModel
    : agentConfig?.model;
